 ...
 * @author kunal
 */
public class systemAdminLoginFrame extends javax.swing.JFrame {

    /**
     * Creates new form systemAdminLogin
     */
    public systemAdminLoginFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sys Admin Login Portal");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(systemAdminLoginFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new systemAdminLoginFrame().setVisible(true);
            }
        });
    }
